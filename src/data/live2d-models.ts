export interface Live2DModelEntry {
    ...
    modelPath: string;
    note?: string;
    // moc3 中 Y 轴方向相反（建模时画反），渲染时需要把 ParamAngleY / ParamBodyAngleY 取反
    flipY?: boolean;
}
...
制作的ai桌面助手:https://github.com/swrited/inni-pet,基于 Electron、PixiJS 和 Live2D Cubism 的桌面宠物项目。当前模型使用仓库内的 inni_model/inni_2_eye.model3.json,窗口内置聊天输入、回复字幕、鼠标追踪和点击触发动作。`,
    },
    {
        slug: "inni-sleep",
        name: "inni_sleep",
    ...
    },
    {
        slug: "inni-box",
        name: "inni_box",
        image: "/images/inni/inni-box-cover.png",
        modelPath: "/images/inni/live2d/inni_box/livefox.model3.json",
        flipY: true,
    },
];
